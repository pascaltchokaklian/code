...
def connected_map(request):
    ...
    if len(activities_df)>0: 
        ...
        for ligne in range(len(activities_df)):
            ...
            last_activity = Activity.objects.all().order_by("-act_id")[0]
            max_act_id = last_activity.act_id

            print('------------------------------------------',max_act_id)

            my_Activity_info1 = Activity_info()
            my_Activity_info1.act_id = max_act_id
            ...
            my_Activity_info2.act_id = max_act_id
            ...
            my_Activity_info3.act_id = max_act_id
